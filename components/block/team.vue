...
const people = [
  {
    ...
    role: 'Partnerships',
    imageUrl: '../../public/GulnaraMustafaeva.jpg',
    // twitterUrl: '#',
    instagramUrl: 'https://www.instagram.com/guliamustafayeva/',
    linkedinUrl: 'https://www.linkedin.com/in/gulia-mustafayeva/',
    facebookUrl: 'https://www.facebook.com/profile.php?id=100001584059213',
    telegramUrl: 'https://t.me/gulnara_mustafayeva',
  },
  {
    name: 'Yulia Movsesova',
    role: 'Communications',
    imageUrl: '../../public/YuliaMovsesova.jpg',
    // twitterUrl: '#',
    // instagramUrl: '#',
    linkedinUrl: 'https://www.linkedin.com/in/yuliamm/',
    // facebookUrl: '#',
    // telegramUrl: '#',
  },
  {
    name: 'Olga Alilovic',
    role: 'Mission',
    imageUrl: '../../public/OlgaAlilovic.jpg',
    // twitterUrl: '#',
    // instagramUrl: '#',
    // linkedinUrl: '#',
    // facebookUrl: '#',
  ...
  },
  {
    ...
    role: 'Coordination',
    imageUrl: '../../public/AlekseyRazabakov.jpg',
    // twitterUrl: '#',
    // instagramUrl: '#',
    linkedinUrl: 'https://www.linkedin.com/in/razbakov/',
    facebookUrl: 'https://www.facebook.com/razbakov',
    telegramUrl: 'https://t.me/AlexRazbakov',
  },
  // More people...
]
</script>
