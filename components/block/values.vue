<template>
  <div class="flex flex-col sm:items-center gap-8  min-h-screen ">
      ...
      <p class="bg-white mx-7  text-dark-grey text-subtitle-3"> 
        ...
        people <strong class="text-orange">hope</strong> and help them through <strong class="text-blue">effective</strong> 
        actions
      </p>

      <img src="/values.svg" class=" self-center max-w-[100%] h-auto object-cover" />
  </div>
</template>
